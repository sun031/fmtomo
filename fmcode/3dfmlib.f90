...
if (ilong < 2 .or. ilong > (iface%nlong-2)) then 
   ...
   ! by weijia 28 July 2016
   if (ilong<2) then
      ilong=2
   elseif (ilong>(iface%nlong-2)) then
      ilong=iface%nlong-2
   endif
   !stop
endif
...
if (ilong < 2 .or. ilong > (gridv%nlong-2))  then
   ...
   if (ilong<2)then
      ilong=2
   elseif(ilong>(gridv%nlong-2))  then
      ilong=(gridv%nlong-2)
   endif
   !stop
endif
